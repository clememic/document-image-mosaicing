...
# Generated by qmake (3.0) (Qt 5.0.2) on: Sun Dec 15 23:25:58 2013
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/opencv -I/usr/include/qt5 -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lopencv_core -lopencv_calib3d -lopencv_highgui -lopencv_features2d -lopencv_flann -lopencv_nonfree -lopencv_stitching -lQt5Gui -L/usr/lib/x86_64-linux-gnu -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	@test -d .tmp/mosaicing1.0.0 || mkdir -p .tmp/mosaicing1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mosaicing1.0.0/ && $(COPY_FILE) --parents src/main.cpp .tmp/mosaicing1.0.0/ && (cd `dirname .tmp/mosaicing1.0.0` && $(TAR) mosaicing1.0.0.tar mosaicing1.0.0 && $(COMPRESS) mosaicing1.0.0.tar) && $(MOVE) `dirname .tmp/mosaicing1.0.0`/mosaicing1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mosaicing1.0.0
