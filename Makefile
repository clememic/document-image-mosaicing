...
# Generated by qmake (3.0) (Qt 5.0.2) on: Wed Dec 18 22:02:06 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/mosaicing1.0.0/ && $(COPY_FILE) --parents src/main.cpp obj/mosaicing1.0.0/ && (cd `dirname obj/mosaicing1.0.0` && $(TAR) mosaicing1.0.0.tar mosaicing1.0.0 && $(COMPRESS) mosaicing1.0.0.tar) && $(MOVE) `dirname obj/mosaicing1.0.0`/mosaicing1.0.0.tar.gz . && $(DEL_FILE) -r obj/mosaicing1.0.0
